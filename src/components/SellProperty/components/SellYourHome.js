  ...
  return (
    <Box sx={{px: {xs: 1, md: 3}}}>
      ...
      >
        ...
        >
          <Typography
            sx={{ fontSize: {xs: "22px", sm: "26px", md: "37px"}, fontWeight: 700, color: "#333333" }}
          >
            Sell your home for top dollar and save on fees
          </Typography>
          <Typography sx={{fontSize: {xs: "10px", sm: "10px", md: "12px",}, color: "#333333", fontWeight: 400}}>
          ...
          <Box sx={{display: "flex", gap: "3px", justifyContent:"center", mt: "19.5px"}}>
            <TextField
              size="small"
